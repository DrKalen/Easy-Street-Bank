-- phpMyAdmin SQL Dump //generated by software vs. written by people Restore = copy this file and paste it into mysql console as one big query
 -
 --the ; tells it to separate lines. Could do this running the seql console from command line $mysql --help

 or in the app import
-- version 4.1.12
