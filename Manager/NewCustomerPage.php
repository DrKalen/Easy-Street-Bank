            ...
            <form name="addcust" action="insrtCustomer.php" method="post" onSubmit="return validatenewCust();">
                ...
                <td colspan="2">
                    ...
                    <table border="0" align="center">
                        ...
                        <!--To display customer name field-->
                        ...
                        <!--To display customer gender field-->
                        ...
                        <!--To display customer date of birth field-->

                        <tr>
                            <td>Date of Birth</td>
                            <td><input type="date" name="dob" id="dob" onKeyUp="validatedob();" onBlur="validatedob();"/><label id="message24"></label></td>
                        </tr>

                        <!--To display customer address field-->

                        <tr>
                            <td>Address</td>
                            <td>
                                <textarea rows="5" cols="20" name="addr" maxlength="50" onKeyUp="validateAddress();" onBlur="validateAddress();"></textarea><label id="message3"></label></td>
                        </tr>
                        ...
                        <!--To display customer telephone number field-->
                        ...
                        <!--To display customer email id field-->
