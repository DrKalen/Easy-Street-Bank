                ...
                <td>
                    <table align=center cellspacing="10"> <!--creating table -->
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="cusid" onKeyUp="validatecustomerid();" onBlur="validatecustomerid();"><label id="message14"></label></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="inideposit" maxlength="8" onKeyUp="validateinideposit();" onBlur="validateinideposit();"><label id="message19"></label></td>
                        </tr>
